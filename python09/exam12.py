...
import pandas as pd
import numpy as np
csv_url = 'https://raw.githubusercontent.com/HyunchanMOON/lessons/master/lessons/gasprices.csv'
csv_save = './data/download/gas.csv'
urllib.request.urlretrieve(csv_url, csv_save)

df = pd.read_csv('./data/download/gas.csv')
print(df)